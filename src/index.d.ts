...
export {nsIFile} from './WebExtensions/Base/nsIFile';
...
export {nsISupports} from './WebExtensions/Base/nsISupports';
export {nsMsgFolderFlags} from './WebExtensions/Base/nsMsgFolderFlags';
export {nsMsgMessageFlags} from './WebExtensions/Base/nsMsgMessageFlags';
export {nsIMsgCopyService} from './WebExtensions/Base/nsIMsgCopyService';
export {nsIAlertNotification} from './WebExtensions/Base/nsIAlertNotification';
export {nsIAlertsService} from './WebExtensions/Base/nsIAlertsService';
export {nsIObserver} from './WebExtensions/Base/nsIObserver';
export {nsIPrincipal} from './WebExtensions/Base/nsIPrincipal';
export {nsIFolderListener, folderListenerNotifyFlagValue} from './WebExtensions/Base/nsIFolderListener';
export {nsITransportSecurityInfo} from './WebExtensions/Base/nsITransportSecurityInfo';
export {nsIMsgUserFeedbackListener} from './WebExtensions/Base/nsIMsgUserFeedbackListener';
export {nsIMsgMailSession} from './WebExtensions/Base/nsIMsgMailSession';
export {nsIMsgIdentity} from './WebExtensions/Base/nsIMsgIdentity';
export {nsIMsgAccount} from './WebExtensions/Base/nsIMsgAccount';
export {nsIMsgAccountManager} from './WebExtensions/Base/nsIMsgAccountManager';
export {nsresult} from './WebExtensions/Base/nsresult';
export {XMLHttpRequestResponseType} from './WebExtensions/Base/XMLHttpRequest/XMLHttpRequestResponseType';
export {XMLHttpRequestEventTarget} from './WebExtensions/Base/XMLHttpRequest/XMLHttpRequestEventTarget';
export {nsIXMLHttpRequest} from './WebExtensions/Base/nsIXMLHttpRequest';
