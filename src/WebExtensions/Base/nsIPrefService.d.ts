...
export interface nsIPrefService extends nsISupports {
     ...
     * @param {nsIFile} aFile - The file to be written.
     ...
     * @param {string} aPrefRoot - The preference "root" on which to base this "branch". For example, if the root
     ...
     * @returns {nsIPrefBranch} The object representing the requested branch.
     ...
     * @param {string} aPrefRoot - The preference "root" on which to base this "branch".
     ...
     * @returns {nsIPrefBranch} The object representing the requested default branch.
     * @see getBranch
     */
